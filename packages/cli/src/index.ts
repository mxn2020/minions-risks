...
/**
 * @minions-risks/cli — CLI for Minions Risks
 *
...
import { customTypes } from '@minions-risks/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Risks'));
        console.log(chalk.dim('Risk register, likelihood, impact, and mitigation plans'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-risks/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-risks/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-risks')}`);
