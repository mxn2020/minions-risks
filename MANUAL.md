# Manual Setup Steps for Minions Risks
...
Go to **GitHub → mxn2020/minions-risks → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-risks` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-risks-web`
- **GitHub repo**: `mxn2020/minions-risks`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `risks.minions.wtf`

### Documentation
- **Netlify site name**: `minions-risks-docs`
- **GitHub repo**: `mxn2020/minions-risks`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `risks.minions.help`

### Blog
- **Netlify site name**: `minions-risks-blog`
- **GitHub repo**: `mxn2020/minions-risks`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `risks.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `risks.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `risks.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `risks.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-risks/sdk`](https://www.npmjs.com/package/@minions-risks/sdk)
- CLI: [`@minions-risks/cli`](https://www.npmjs.com/package/@minions-risks/cli)
...
Your package: [`minions-risks`](https://pypi.org/project/minions-risks/)
...
| Item | Value |
|------|-------|
| Project | `minions-risks` |
| SDK (npm) | `@minions-risks/sdk` |
| CLI (npm) | `@minions-risks/cli` |
| Python (PyPI) | `minions-risks` |
| GitHub | `github.com/mxn2020/minions-risks` |
| Docs domain | `risks.minions.help` |
| Blog domain | `risks.minions.blog` |
| App domain | `risks.minions.wtf` |
